...
namespace TeleHook.Api.Migrations
{
    ...
    [Migration("20250710154006_SavePendingChanges")]
    partial class SavePendingChanges
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("TeleHook.Api.Models.User", b =>
                {
                    ...
                    b.ToTable("Users", t =>
                        {
                            t.HasCheckConstraint("CK_Users_AuthMethod", "(PasswordHash IS NOT NULL AND AuthProvider = 'credentials') OR (OidcId IS NOT NULL AND AuthProvider = 'oidc')");

                            t.HasCheckConstraint("CK_Users_AuthProvider", "AuthProvider IN ('credentials', 'oidc')");
            ...
            modelBuilder.Entity("TeleHook.Api.Models.Webhook", b =>
                {
                    ...
                    b.ToTable("Webhooks", t =>
                        {
                            t.HasCheckConstraint("CK_Webhooks_ParseMode", "ParseMode IN ('HTML', 'Markdown', 'MarkdownV2')");
                        });
                });
